...
-- ----------------------------
BEGIN;
INSERT INTO `__PREFIX__admin` VALUES ('1', 'admin', 'Admin', '', 'admin@fladmin.com', '18888888888', '0', '1652166427', '127.0.0.1', 'dc82034ba4108148cbefd980b6b63371', 'kWlGDm9qAVB8MjbX', '', '1645876529', '1652166427', '1');
COMMIT;
...
CREATE TABLE `__PREFIX__admin_group` (
    ...
    `half_rules` text COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '半选中规则',
    `createtime` int(10) DEFAULT NULL COMMENT '创建时间',
    `updatetime` int(10) DEFAULT NULL COMMENT '更新时间',
    `status` enum('1','0') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '1' COMMENT '状态:0=禁用,1=启用',
    PRIMARY KEY (`id`)
...
INSERT INTO `__PREFIX__menu_rule` VALUES ('76', '0', 'menu', 'fladmin', 'fladmin/fladmin', 'fladmin', 'local-logo', 'link', 'https://doc.fladmin.com', '', '0', 'none', '', '0', '0', '1651926977', '1648947396');
...
-- ----------------------------
BEGIN;
INSERT INTO `__PREFIX__user` VALUES ('1', '1', 'user', 'User', 'user@fladmin.com', '18888888888', '', '2', '2022-05-13', '0', '0', '1648156017', '127.0.0.1', '0', '', '1648156017', '', '', '', 'enable', '1650731874', '1648156017');
COMMIT;
...
CREATE TABLE `__PREFIX__user_group` (
    ...
    `half_rules` text COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '半选中权限',
